...
import { Wallet, LogOut, Radio, HelpCircle } from 'lucide-react';
          ...
          <div className="flex items-center space-x-2">
            ...
            {isConnected && walletAddress ? (
              ...
              <button
                ...
                className="flex items-center space-x-1.5 px-3 py-1 rounded-full bg-brand-emerald/15 hover:bg-brand-emerald/25 border border-brand-emerald/40 text-xs font-mono text-brand-emerald hover:text-white transition-all active:scale-95 shadow-sm"
              >
